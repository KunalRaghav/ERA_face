...
public class CameraFragment extends Fragment
     ...
     */
    private Integer facing_direction=CameraCharacteristics.LENS_FACING_BACK;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            values.put(MediaStore.Images.Media.ORIENTATION, ORIENTATIONS.get(1));
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.switch_cam).setOnClickListener(this);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing != facing_direction) {
                    continue;
                }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.switch_cam:{
                if(facing_direction==CameraCharacteristics.LENS_FACING_BACK){
                    facing_direction=CameraCharacteristics.LENS_FACING_FRONT;
                }else{
                    facing_direction=CameraCharacteristics.LENS_FACING_BACK;
                }
                closeCamera();
                openCamera(mTextureView.getWidth(),mTextureView.getHeight());
